module.exports = {
  botoes: {
    ...
    btnContinuarContainer: "//android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[7]"
  },

  campos: {
    campoComoQuerSerChamado:
    ...
    checkAceitoCompartilharDados: "//android.view.ViewGroup[6]/android.widget.TextView"
  },


  labels: {
    labelComoQuerSerChamado: "Como quer ser chamado(a)?",
